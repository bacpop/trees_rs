...
pub fn char_to_mutation(i: usize, e: &char) -> Mutation {
    match e {
        // (A, C, G, T)
        'A' => Mutation(i, 0.0, -f64::INFINITY, -f64::INFINITY, -f64::INFINITY),
        'C' => Mutation(i, -f64::INFINITY, 0.0, -f64::INFINITY, -f64::INFINITY),
        'G' => Mutation(i, -f64::INFINITY, -f64::INFINITY, 0.0, -f64::INFINITY),
        'T' => Mutation(i, -f64::INFINITY, -f64::INFINITY, -f64::INFINITY, 0.0),
        'Y' => Mutation(i, -f64::INFINITY, f64::ln(0.5), -f64::INFINITY, f64::ln(0.5)),
        'W' => Mutation(i, f64::ln(0.5), -f64::INFINITY, -f64::INFINITY, f64::ln(0.5)),
        'R' => Mutation(i, f64::ln(0.5), -f64::INFINITY, f64::ln(0.5), -f64::INFINITY),
        'K' => Mutation(i, -f64::INFINITY, -f64::INFINITY, f64::ln(0.5), f64::ln(0.5)),
        'S' => Mutation(i, -f64::INFINITY, f64::ln(0.5), f64::ln(0.5), -f64::INFINITY),
        'M' => Mutation(i, f64::ln(0.5), f64::ln(0.5), -f64::INFINITY, -f64::INFINITY),
        'B' => Mutation(i, -f64::INFINITY, f64::ln(1.0 / 3.0), f64::ln(1.0 / 3.0), f64::ln(1.0 / 3.0)),
        'D' => Mutation(i, f64::ln(1.0 / 3.0), -f64::INFINITY, f64::ln(1.0 / 3.0), f64::ln(1.0 / 3.0)),
        'V' => Mutation(i, f64::ln(1.0 / 3.0), f64::ln(1.0 / 3.0), f64::ln(1.0 / 3.0), -f64::INFINITY),
